...
from pysports.api.constants import HOME, REGULAR_SEASON, WIN
from pysports.api.ncaaf.boxscore import Boxscore
from pysports.api.ncaaf.constants import SCHEDULE_URL
from pysports.api.ncaaf.schedule import Schedule
