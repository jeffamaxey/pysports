...
class BoxscorePlayer(AbstractPlayer):
    ...
    player_data : string
        ...
        page. If the player appears in multiple tables, all their
...
class Boxscore:
    ...
    def _retrieve_html_page(self, uri):
        ...
        if not utils.check_url_validity(url):
        ...
        try:
            ...
            return None
        if (
            "404 error" in str(url_data).lower()
            or "invalid url" in str(url_data).lower()
        ):
            return None
        return (
            pq(utils._remove_html_comment_tags(url_data))
            if str(pq(utils._remove_html_comment_tags(url_data))) != "[<p>]"
            else None
        )
    ...
    def _parse_game_date_and_location(self, boxscore):
        ...
        boxscore : PyQuery object
            A PyQuery object containing all the HTML data from the boxscore.
        """
    ...
    def _parse_summary(self, boxscore):
        ...
        ----------
        boxscore : PyQuery object
            A PyQuery object containing all the HTML from the boxscore.
...
class Boxscores:
    ...
    def games(self):
        """
        Returns a ``dictionary`` object representing all the games played on
    ...
    def _get_name(self, name):
        ...
        whether they compete in Division-I.
        ...
        -------
        tuple
            Returns a tuple containing the name, abbreviation, and whether
            the team participates in Division-I. Tuple is in the following
    ...
    def _get_team_names(self, game):
        ...
        tuple
            ...
            participate in Division-I athletics, and a boolean which evaluates
    ...
    def _extract_game_info(self, games):
        ...
        list
            ...
            boolean value indicating whether both teams compete in
