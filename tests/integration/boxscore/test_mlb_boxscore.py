...
from pysports.api.constants import HOME
from pysports.api.mlb.constants import BOXSCORE_URL, BOXSCORES_URL, NIGHT
from pysports.api.mlb.boxscore import Boxscore, Boxscores
...
class TestMLBBoxscore:
    ...
    def test_mlb_boxscore_string_representation(self):
        expected = (
            "Boxscore for San Francisco Giants at "
