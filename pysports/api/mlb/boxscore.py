...
class BoxscorePlayer(AbstractPlayer):
    ...
    player_data : string
        ...
        page. If the player appears in multiple tables, allir
...
class Boxscore:
    ...
    def _parse_game_date_and_location(self, boxscore):
        ...
        boxscore : PyQuery object
            A PyQuery object containing all HTML data from the boxscore.
        """
    ...
    def _parse_summary(self, boxscore):
        ...
        ----------
        boxscore : PyQuery object
            A PyQuery object containing all HTML from the boxscore.
...
class Boxscores:
    ...
    def games(self):
        """
        Returns a ``dictionary`` object representing all games played on
