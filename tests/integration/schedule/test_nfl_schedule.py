...
from pysports.api.constants import AWAY, REGULAR_SEASON, WIN
from pysports.api.nfl.boxscore import Boxscore
from pysports.api.nfl.constants import SCHEDULE_URL
from pysports.api.nfl.schedule import Schedule
