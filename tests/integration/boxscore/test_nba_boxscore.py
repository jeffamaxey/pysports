...
from pysports.api.constants import AWAY
from pysports.api.nba.constants import BOXSCORE_URL, BOXSCORES_URL
from pysports.api.nba.boxscore import Boxscore, Boxscores
...
class TestNBABoxscore:
    ...
    def test_nba_boxscore_string_representation(self):
        expected = (
            "Boxscore for Houston Rockets at Utah Jazz " "(9:00 PM, February 22, 2020)"
        )
