...
from pysports.api.nhl.constants import BOXSCORE_URL, BOXSCORES_URL
from pysports.api.nhl.boxscore import Boxscore, Boxscores
...
class TestNHLBoxscore:
    ...
    def test_nhl_boxscore_string_representation(self):
        expected = (
            "Boxscore for Arizona Coyotes at Vancouver Canucks " "(March 4, 2020)"
        )
